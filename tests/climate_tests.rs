use eco_weave::validation::climate::{
    validate_dew_point, validate_humidity, validate_pressure, validate_rainfall,
    validate_temperature, validate_uv_index, validate_wind_direction, validate_wind_speed,
};
